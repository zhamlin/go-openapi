...
type OpenAPI struct {
	...
	Components *Extendable[Components] `json:"components,omitempty"`
	// REQUIRED
	// Provides metadata about the API. The metadata MAY be used by tooling as required.
	Info *Extendable[Info] `json:"info"`
	...
	Paths *Extendable[Paths] `json:"paths,omitempty"`
	...
	Tags []*Extendable[Tag] `json:"tags,omitempty"`
